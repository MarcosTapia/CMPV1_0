<?php
    ...
    //notificacion = idUsuario + "|" + idUsuarioOperador + "|" +  idNotificacion + "|" + mensajeToTecnico + "|";
    ...
    */
    $mensaje = "Mensaje de: ".$operador."<br>".$notificacionArray[3];
    $sql = "update notificaciones set fechaEnvioNotificacionAlTecnico='".$fecha."',idUsuarioTecnico='".$notificacionArray[0]."' where id=".$notificacionArray[2];
    if (mysqli_query($conn, $sql) == TRUE) {
        //grabastatusmaquina  layout_maq_status
        $sql = "update layout_maq_status set status=0,idNotificacion=".$notificacionArray[2]." where idMaq=".$notificacionArray[3];
