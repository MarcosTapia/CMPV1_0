            ...
            <div class="col-sm-6">
                <form enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/fallas_controller/nuevoFallaFromFormulario" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <textarea class="form-control" rows="5" id="descripcionFalla" name="descripcionFalla"></textarea>
                      </div>					  
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div id="Selector">
                                <input type="file" name="imagen4" id="foto4" class="SubirFoto" accept="image/*" capture="camera" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div id="Selector">
                                <input type="file" name="imagen5" id="foto5" class="SubirFoto" accept="image/*" capture="camera" />
