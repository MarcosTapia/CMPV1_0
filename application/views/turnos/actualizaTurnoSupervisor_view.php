...
<body>     
    <div class="container">
        <div class="row-fluid">
            ...
            <div class="col-sm-6">
                <form onsubmit="javascript:return muestraHoras();" class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/mantenimiento_controller/actualizarTurnoFromFormularioSupervisor" method="post">
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?php echo base_url();?>index.php/mantenimiento_controller/mostrarTurnosSupervisor">
