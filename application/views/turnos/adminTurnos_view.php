...
<div class="col-md-12">
    ...
    <?php } ?>
    <br>
    <h3 style="background-color:#C13030; color:white;text-align: center">Administraci&oacute;n de Técnicos/Turnos</h3>
    <br>
    <p>
        <a class="btn btn-primary" href="nuevoTurno">Nuevo Usuario/Turno</a>
    </p>
                ...
                if($turnos) {
                    ...
                    foreach($turnos as $fila) { ?>
                        <tr id="fila-<?php echo $fila->{'idTurno'} ?>">
                            ...
                            <td>
                            <a href="actualizarTurno/<?php echo $fila->{'idTurno'} ?>"><img src="<?php echo base_url(); ?>/images/sistemaicons/modificar.ico" alt="Editar" title="Editar" /></a>                            
                            &nbsp;&nbsp;
                            <a href="eliminarTurno/<?php echo $fila->{'idTurno'} ?>"  onclick="javascript: return preguntar()"><img src="<?php echo base_url(); ?>/images/sistemaicons/borrar2.ico" alt="Borrar" title="Borrar" /></a>
                            &nbsp;&nbsp;
                            <a href="mostrarGraficoTecnico/<?php echo $fila->{'idUsuario'} ?>"><img src="<?php echo base_url(); ?>/images/sistemaicons/grafica.ico" alt="Gráficos Rendimiento" title="Gráficos Rendimiento" /></a>
                            &nbsp;&nbsp;
