                ...
                if($maquinas) {
                    ...
                    foreach($maquinas as $fila) { ?>
                        ...
                        <tr id="fila-<?php echo $fila->{'idMaquina'} ?>">
                            ...
                            <td><?php echo $fila->{'apusu'}." ".$fila->{'amusu'}." ".$fila->{'nomusu'} ?></td>
                            <td><?php echo $fila->{'descripcion'} ?></td>
                            <td><?php echo $fila->{'descripcion_categoria'} ?></td>
                            <td><?php 
                                if ($fila->{'status'} == 1) {
                                    echo "<input type='button' class='btn btn-success' disabled value=' ' style='border:1px solid;border-radius:22px;' />";
                                } else {
                                    echo "<input type='button' class='btn btn-danger' disabled value=' ' style='border:1px solid;border-radius:22px;' />";
                                }?></td>
                            <td><?php echo $fila->{'nomprov'} ?></td>
                            <td>
                            ...
                            <a href="<?php echo base_url();?>index.php/mantenimiento_controller/creaFormatoActividades/<?php echo $fila->{'idMaquina'} ?>"><img src="<?php echo base_url(); ?>/images/sistemaicons/nota.ico" alt="Crea documento de Actividades" title="Crea documento de Actividades" /></a>
                            </td>
                        </tr>
                      <?php 
