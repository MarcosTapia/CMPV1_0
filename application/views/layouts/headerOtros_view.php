              ...
              <div class="container-fluid">
                ...
                <div><br></div>  
                  <ul class="nav navbar-nav">
                    ...
                    <?php if ($opcionClickeada == 'Mantenimientos') { ?>
                        <li><a id="actividades" style="background-color:#C13030; color:white;" href="<?php echo base_url(); ?>index.php/mantenimiento_controller/consultaMantenimientosOtros">Mantenimientos</a></li>
                    <?php } else { ?>
                        <li><a id="actividades" href="<?php echo base_url(); ?>index.php/mantenimiento_controller/consultaMantenimientosOtros">Mantenimientos</a></li>
                    <?php } ?>
