                ...
                <div><br></div>  
                  <ul class="nav navbar-nav">
                    ...
                    <?php if ($opcionClickeada == 'Mantenimientos') { ?>
                          <li><a id="mantenimientos" style="background-color:#C13030; color:white;" href="<?php echo base_url(); ?>index.php/mantenimiento_controller/consultaMantenimientosPublico">Mantenimientos</a></li>
                    <?php } else { ?>
                          <li><a id="mantenimientos" href="<?php echo base_url(); ?>index.php/mantenimiento_controller/consultaMantenimientosPublico+
						  ">Mantenimientos</a></li>
                    <?php } ?>    
