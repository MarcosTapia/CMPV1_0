...
//        $('#datepicker').datepicker('setStartDate', 0);
                    ...
                    foreach($mantenimientos as $fila) {?>
                        <tr id="fila-<?php echo $fila->{'idFechaMantenimiento'} ?>">
                            ...
                            <td>
                                ...
                                <a href="actualizarMantenimientoTecnico2FromBtn/<?php echo $fila->{'idFechaMantenimiento'}."/".trim(substr($fila->{'fechaMantenimiento'},7,9)); ?>" class="btn btn-primary" />Atender</a>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <?php } ?>
                                <a href="actualizarMantenimientoTecnico2/<?php echo $fila->{'idFechaMantenimiento'}."/".$fila->{'idMaquina'}; ?>"><img src="<?php echo base_url(); ?>/images/sistemaicons/modificar.ico" alt="Editar" title="Editar" /></a>                            
                            </td>
                        </tr>
                      <?php                   
                      $i++;  
