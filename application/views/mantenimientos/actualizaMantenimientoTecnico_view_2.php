...
<body>      
    <div class="container"> <!--class="container-fluid" -->
        ...
        <div class="row-fluid">
            <div class="col-sm-12">
                <form enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/mantenimiento_controller/actualizarMantenimientoFromFormularioTecnico2" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <a style="margin-left: 30px" href="<?php echo base_url();?>index.php/mantenimiento_controller/mostrarMantenimientosSemanaUsuario2">
