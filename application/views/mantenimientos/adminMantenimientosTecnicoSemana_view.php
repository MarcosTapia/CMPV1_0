        ...
        <div class="table-responsive">  
            <table class="table">
                <tr>
                    ...
                    <td>
                        <br>
                        <form onsubmit="javascript: return verificaFechas()" class="form-inline" action="<?php echo base_url();?>index.php/mantenimiento_controller/mostrarMantenimientosSemanaUsuario" method="post">
                    ...
                    foreach($mantenimientos as $fila) {?>
                        <tr id="fila-<?php echo $fila->{'idFechaMantenimiento'} ?>">
                            ...
                            <td><?php
                                ...
                                ?>
                            <td>
                            <a href="actualizarMantenimientoTecnico/<?php echo $fila->{'idFechaMantenimiento'}."/".$fila->{'idMaquina'}; ?>"><img src="<?php echo base_url(); ?>/images/sistemaicons/modificar.ico" alt="Editar" title="Editar" /></a>                            
                            </td>
                        </tr>
                      <?php                   
                      $i++;  
