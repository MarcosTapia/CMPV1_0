...
<div class="col-md-12">
    ...
    <div>
        <div class="table-responsive">  
            <table class="table">
                <tr>
                    <td>
                        <form onsubmit="javascript: return verificaFechas()" class="form-inline" action="<?php echo base_url();?>index.php/mantenimiento_controller/consultaMantenimientosHistorico" method="post">
                            <div class="form-group mx-sm-4 mb-3" style="margin-left:30px;">
    ...
    <div class="table-responsive">  
        <center>
            <div>
                <input onmousemove="//activaSelectResponsable();" type="submit" class="btn btn-danger" name="submit" value="Buscar" style="margin-top:-20px;"/>
            </form>                        
                <form action="<?php echo base_url();?>index.php/mantenimiento_controller/exportarExcel" method="post" style="display:inline;margin-left: 10px;">  
                ...
                <form action="<?php echo base_url();?>index.php/mantenimiento_controller/verManttoPdf" method="post" style="display:inline;margin-left: 10px;">    
                      <?php if (isset($mantenimientos)) { ?>
    ...
    <div class="table-responsive">   
        ...
        <?php
        if (trim($week) != "||") { ?>
        <h3 class="h3 text-info font-weight-bold text-center" style="color:#cc0000;">
                Mantenimientos de la Semana: <?php $weeks = explode("|",$week); if ($weeks[1]!="") { echo $weeks[0]." a "
                .$weeks[1]; } else { echo $weeks[0]; }?> Año: <?php echo $anio; ?></h3>
        <?php }
            if ($idResponsable != 0) { 
        ...
        ?>
        <h3 class="h3 text-info font-weight-bold text-center"><?php echo $cadena; ?></h3>
        ...
        <table class="table" cellpadding="0" cellspacing="0" border="0" class="display" id="example">
            <thead>
                <tr>
                    ...
                    <th>Responsable</th>
                    <th>Status</th>
                    <th><img src="<?php echo base_url(); ?>/images/sistemaicons/clientes.ico" alt='Supervisión' title='Supervisión'/></th>
                    <th>Observaciones</th>
                </tr>
            </thead>
            <tbody>
                        ...
                        <tr id="fila-<?php echo $fila->{'idFechaMantenimiento'} ?>">
                            ...
                            <td>
                                <?php if ($fila->{'verificada'} == ""){ ?>
                                    <img style="margin-top:17px;" id="img<?php echo $fila->{'idFechaMantenimiento'} ?>" src="<?php echo base_url(); ?>/images/sistemaicons/persona.ico" alt="Por verificar" title="Por verificar" />
                                <?php } else { ?>
                                    <img style="margin-top:17px;" id="img<?php echo $fila->{'idFechaMantenimiento'} ?>" src="<?php echo base_url(); ?>/images/sistemaicons/ojobuscar.ico" alt="Verificada" title="Verificada" />
                                <?php } ?>
                            </td>
                            <td>
