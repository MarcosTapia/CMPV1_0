                ...
                if($soluciones) {
                    ...
                    foreach($soluciones as $fila) { ?>
                        <tr id="fila-<?php echo $fila->{'idFalla'} ?>">
                            ...
                            &nbsp;&nbsp;
                            <a href="<?php echo base_url();?>index.php/soluciones_controller/eliminarSolucion/<?php echo $fila->{'idSolucion'} ?>/<?php echo $fila->{'idFalla'} ?>"  onclick="javascript: return preguntar()"><img src="<?php echo base_url(); ?>/images/sistemaicons/borrar2.ico" alt="Borrar" title="Borrar" /></a>
                            </td>
                        </tr>
                      <?php 
