                ...
                if($fallas) {
                    ...
                    foreach($fallas as $fila) { ?>
                        <tr id="fila-<?php echo $fila->{'idFalla'} ?>">
                            ...
                            &nbsp;&nbsp;
                            <a href="agregarSolucion/<?php echo $fila->{'idFalla'} ?>"><img src="<?php echo base_url(); ?>/images/sistemaicons/lista.ico" alt="Ver soluciónes" title="Ver soluciónes" /></a>                            
                            &nbsp;&nbsp;
                            <a href="eliminarFalla/<?php echo $fila->{'idFalla'} ?>/<?php echo $fila->{'idFalla'} ?>"  onclick="javascript: return preguntar()"><img src="<?php echo base_url(); ?>/images/sistemaicons/borrar2.ico" alt="Borrar" title="Borrar" /></a>
                            </td>
                        </tr>
                      <?php 
