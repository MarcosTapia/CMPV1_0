        ...
        <div class="row-fluid">
            ...
            <div class="col-sm-6">
                <form enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/fallas_controller/nuevoFallaFromFormulario" method="post">
                    <input type="hidden" name="idSolucionHd" value="<?php echo $solucion->{'idSolucion'}; ?>"
                    <br>
                    <h4>Detalle de la Solución:</h4>
                    <br>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="descripcionFalla">Falla:</label>
                      <div class="col-sm-10">
                          <textarea class="form-control" rows="5" id="descripcionFalla" name="descripcionFalla" disabled><?php echo $solucion->{'descripcionFalla'}; ?></textarea>
                      </div>					  
                    </div> 

                    <div class="form-group">
                      <label class="control-label col-sm-2" for="descripcionSolucion">Solución:</label>
                      <div class="col-sm-10">
                          <textarea class="form-control" rows="5" id="descripcionSolucion" name="descripcionSolucion" disabled><?php echo $solucion->{'descripcionSolucion'}; ?></textarea>
                      </div>					  
                    </div> 

                    <div class="form-group">
                      <label class="control-label col-sm-2" for="maquina">Máquina:</label>
                      <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $falla->{'nombre_maquina'}.". Número: ".$falla->{'numero_maquina'}; ?>" />
                      </div>					  
                    </div> 
                    
                    <?php 
                      $fotosArray = explode("|", $solucion->{'evidenciaSolucion'}); 
                      $foto1 = "";
                      $foto2 = "";
                      $foto3 = "";
                      $foto4 = "";
                      ...
                      foreach($fotosArray as $fila) {
                          $tipoArchivo = explode(".",$fila);
                          $tipoArchivo = $tipoArchivo[sizeof($tipoArchivo) - 1];
                          if ($tipoArchivo == "jpg") {
                            switch ($contFotos) {
                                case 1:
                                    if ($tipoArchivo == "jpg") {
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php if ($foto1 != "") { $rutaFotos = $rutaFotosOrigen.$foto1; ?>
                            <a href="<?php echo $rutaFotos; ?>">Ver Detalle</a>
                            <?php } ?>
                        </div>
                        <div class="col-sm-6">
                            <div id="Selector">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php } ?>
                            <h4>Vista previa:</h4>
                            <?php if ($foto3 != "") { $rutaFotos = $rutaFotosOrigen.$foto1; ?>
                            <a href="<?php echo $rutaFotos; ?>">Ver Detalle</a>
                            <?php } ?>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <div class="col-sm-6">
                            ...
                            <h4>Archivo: <a href="<?php echo $rutaFotos; ?>"><?php echo $foto4; ?></a></h4>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?php echo base_url();?>index.php/soluciones_controller/mostrarSolucionesPorIdFalla/<?php echo $solucion->{'idFalla'} ?>">
