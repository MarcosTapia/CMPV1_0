...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <?php } ?>
            <br>
            <h3 style="background-color:#C13030; color:white;text-align: center">Administraci&oacute;n de Proveedores</h3>
            <br>
            <p>
                        ...
                        if(isset($proveedores)) {
                            ...
                            ?>
                                <tr id="fila-<?php echo $fila->{'idProveedor'} ?>">
                                    ...
                                    <td>
                                        <a href="actualizarProveedor/<?php echo $fila->{'idProveedor'} ?>"><img src="<?php echo base_url(); ?>/images/sistemaicons/modificar.ico" alt="Editar" title="Editar" /></a>                            
                                        <a href="eliminarProveedor/<?php echo $fila->{'idProveedor'} ?>/<?php echo $fila->{'idProveedor'} ?>"  onclick="javascript: return preguntar()"><img src="<?php echo base_url(); ?>/images/sistemaicons/borrar2.ico" alt="Borrar" title="Borrar" /></a>
                                    </td>
                                </tr>
                                <?php $i++; 
                            }   
