...
$sql = "SELECT * from mantenimientos where idMaquina=".$_GET['idMaquina'];
...
while( $row = mysqli_fetch_assoc($res) ) { 
    ...
    if ($v == false){
        ...
        $row['text'] = "<p style='margin-top:-15px;margin-bottom:-3px;' onclick='muestraInfoSemanas(".$row['idActividad'].",".$_GET['idMaquina'].")'><img src='http://192.168.98.200/cmpv1_0/images/sistemaicons/adelante.ico' />&nbsp;&nbsp;&nbsp;".$elemArrayAct[0]."</p>"; 
